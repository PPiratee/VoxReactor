...
namespace CheesyFX
{
    public static class Extensions
    {
        ...
        public static SetBoolCallback AddCallback2(this JSONStorableBool jsonParam, Action<bool> callbackDelegate)
        {
            SetBoolCallback setBoolCallback = new SetBoolCallback(callbackDelegate);
            jsonParam.setCallbackFunction += setBoolCallback;

            return setBoolCallback;
        }
        public static void RemoveCallback(this JSONStorableBool jsonParam, SetBoolCallback callback)
        {
        ...
        public static void AddCallbackDontCall(this JSONStorableString jsonParam, Action<string> callback)
        {
            jsonParam.setCallbackFunction += val => callback(val);
        ...
        public static void AddCallbackDontCall(this JSONStorableStringChooser jsonParam, Action<string> callback)
        {
            jsonParam.setCallbackFunction += val => callback(val);
        }
